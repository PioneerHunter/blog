  ...
  <div id="grid">
    <div id="signup">
      ...
      <form action="">
        <div class="form-ele">
          <span>账号：</span>
          <input type="text" placeholder="输入用户名" v-model="signupNmae" />
        </div>
        <div class="form-ele">
          <span>密码：</span>
    ...
    signup() {
      ...
      axios
        ...
        .then(function (response) {
          console.log(that.signinName);
          console.log(that.signupPwd);
          that.signupResponse = response.data;
          alert("注册成功！快去登录吧！");
        })
        .catch(function (error) {
          console.log(that.signinName + 123);
          console.log(that.signupPwd + 123);
          alert("注册失败，请重试");
          console.log(error);
        });
    },
